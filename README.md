...
```bash
usage: shiba2sashimi.py [-h] -e EXPERIMENT -s SHIBA -o OUTPUT [--id ID] [-c COORDINATE] [--strand STRAND] [--samples SAMPLES] [--groups GROUPS] [--colors COLORS] [--exon_s EXON_S] [--intron_s INTRON_S] [--font_family FONT_FAMILY]
                        [-v]
...
options:
  ...
  --groups GROUPS       Groups to plot. e.g. group1,group2,group3 Default: all groups in the experiment table
